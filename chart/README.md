...
| `image.tag` | string | `"1.0.5"` | Container image tag. |
...
| `relay.receiveLocalOutgoing` | bool | `false` | Adds `--receiveLocalOutgoing` to capture locally generated multicast traffic through AF_PACKET sockets. |
